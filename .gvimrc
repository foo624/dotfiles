...
" インストール先
" ~/.vim/pack/themes/opt/vim-solarized8
" git clone https://github.com/lifepillar/vim-solarized8.git
set background=dark
colorscheme solarized8

highlight Pmenu ctermbg=13 guifg=#c0c0c0 guibg=#404080
...
"  set guifontset=a9,r9,k9
  set guifont=-mplus-gothic-medium-r-normal--10-100-75-75-c-100-jisx0208.1990-0
elseif has('unix')
"  set guifont=東風ゴシック\ 9
endif
